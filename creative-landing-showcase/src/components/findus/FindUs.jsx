  ...
  const items = [
    {
      ...
      description:
        "Start a project management career with our industry-recognized, accredited online courses.",
    },
    {
      img: f2,
    ...
    },
    {
      ...
      description:
        "Excel in office administration and receptionist roles with our accredited, career-advancing programs.",
    },
  ];
    ...
    <div className="container">
      <div className="max-w-screen-lg mx-auto ">
        <div className="flex flex-col items-center justify-center mx-auto space-y-10 text-xl font-bold text-center font-jakarta">
          <h1 className="mt-10 transition-colors duration-300 ease-in-out md:w-4/12 hover:text-orange-500 ">
            Find Your Perfect Fit: Dive into Our Diverse Categories
          </h1>
          <p className="mx-5 text-sm font-normal md:mx-0 md:w-6/12 ">
      ...
      <div className="flex flex-col items-center max-w-screen-lg mx-5 mt-10 md:mx-auto">
        {/* Content */}
        <div
          className={`grid w-full grid-cols-1 sm:grid-cols-4 gap-4 mb-4 font-jakarta transition-transform duration-500 ease-in-out`}
        >
          ...
          {items
            ...
            .map((item, index) => (
              <div
                key={index}
                className="p-4 space-y-4 transition-transform duration-300 transform bg-white rounded-lg shadow hover:scale-105"
              >
        ...
        <div className="flex items-center justify-between w-full max-w-xs my-5">
          {/* Navigation Buttons */}
          <button
            className="p-2 text-white transition-transform duration-300 transform bg-black rounded-full disabled:opacity-50 hover:scale-110"
            onClick={handlePrev}
          ...
          <div className="relative w-64 h-1 mx-2 overflow-hidden bg-gray-300 rounded-full">
            <div
              className="absolute h-full duration-500 ease-in-out bg-black rounded-full transition-width"
